...
* **AVG:** The mathematical average of all voltages present in the bus. The average is calculated by summing all signals and then dividing by the number of active channels.  
